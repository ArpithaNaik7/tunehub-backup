...
public class PaymentController {
	...
	public String createOrder(HttpSession session) {
		...
		try {
			RazorpayClient razorpay=new RazorpayClient("rzp_test_7OX7B3SW2uWLwS", "fgeBIah6fi5EtYDQcw8YvEup");
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
		...
		try {
			...
			RazorpayClient razorpayClient = new RazorpayClient("rzp_test_7OX7B3SW2uWLwS","fgeBIah6fi5EtYDQcw8YvEup");
